        ...
        <div className="md:w-2/3 text-center md:text-left">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mb-10 text-left">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <p className="font-bold text-gray-800">120+ Completed</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                    <p className="text-sm text-gray-500">Companies</p>
                    <p className="font-bold text-gray-800">8+ Worked</p>
                </div>
            </div>
            <div className="flex justify-center md:justify-start items-center space-x-4">
                <p className="text-gray-600 font-medium">My Skills:</p>
                <div className="flex items-center space-x-3">
                    <img src="https://www.vectorlogo.zone/logos/figma/figma-icon.svg" alt="Figma" className="w-7 h-7"/>
                    <img src="https://www.vectorlogo.zone/logos/sketchapp/sketchapp-icon.svg" alt="Sketch" className="w-7 h-7"/>
                    <img src="https://www.vectorlogo.zone/logos/adobe_xd/adobe_xd-icon.svg" alt="Adobe XD" className="w-7 h-7"/>
